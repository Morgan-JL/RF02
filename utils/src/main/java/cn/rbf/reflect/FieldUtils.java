...
public abstract class FieldUtils {
  ...
  /**
   * 返回集合属性的泛型,如果不是java自带的类型，会在泛型类型后加上$ref<br> List[String]  ->String<br> Map[String,Ingeger]
   * ->[String,Integer]<br> Map[String,MyPojo]   ->[String,MyPojo$ref]<br>
   */
  ...
  public static Object getValue(Object fieldObject, Field field) {
    try {
      ...
      throw new LuckyReflectionException(
          "无法通过反射机制获取属性值！Field: " + field + ", Object: " + fieldObject, e);
    }
  }
  ...
  public static void setValue(Object fieldObject, Field field, Object fieldValue) {
    try {
      ...
      throw new LuckyReflectionException(
          "无法通过反射机制为属性赋值！Field: " + field + ", Object: " + fieldObject + ", FieldValue: "
              + fieldObject, e);
    }
  }
