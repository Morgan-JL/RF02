 ...
 */
public class RBFServiceLoader<S> implements Iterable<S> {

    private static final String PREFIX = "META-INF/rbf/";
    ...
    private RBFServiceLoader(Class<S> svc, ClassLoader cl) {
    ...
    public static <S> RBFServiceLoader<S> load(Class<S> service, ClassLoader loader) {
        return new RBFServiceLoader<>(service, loader);
    }


    public static <S> RBFServiceLoader<S> load(Class<S> service) {
        ClassLoader cl = Thread.currentThread().getContextClassLoader();
        return RBFServiceLoader.load(service, cl);
    }
