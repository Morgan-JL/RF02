package cn.rbf.conversion.proxy;

import cn.rbf.conversion.LuckyConversion;
import cn.rbf.conversion.annotation.Conversion;
import cn.rbf.proxy.CglibProxy;
...
public class ConversionProxy {
    ...
    public static<T extends LuckyConversion> T getLuckyConversion(Class<T> childInterfaceClass){
        ...
        Class<? extends LuckyConversion>[] luckyConversionClasses=childInterfaceClass.getAnnotation(
            Conversion.class).value();
        ...
        T luckyConversion= CglibProxy
            .getCglibProxyObject(childInterfaceClass,conversionMethodInterceptor);
