...
import cn.rbf.conversion.EntityAndDto;
import cn.rbf.conversion.LuckyConversion;
import cn.rbf.conversion.annotation.Mapping;
import cn.rbf.conversion.annotation.Mappings;
...
public class EDProxy extends Conversion {
    ...
    public static <T extends LuckyConversion> T getProxy(Class<T> childInterfaceClass){
        ...
        Class<? extends LuckyConversion>[] luckyConversionClasses=childInterfaceClass.getAnnotation(
            cn.rbf.conversion.annotation.Conversion.class).value();
