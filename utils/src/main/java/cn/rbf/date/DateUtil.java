...
public class DateUtil {
    ...
    public static final String FORMAT_CST = "E MMM dd HH:mm:ss z yyyy";
    ...
    public static String formatDateSecond(Integer unixSecond) {
    ...
    public static Integer stringTimestamp(String str, String format) {
        SimpleDateFormat sdf = new SimpleDateFormat(format);
        try {
    ...
    /**
     * @param str
     * @desc 字符串 转换为 integer类型的时间戳的字符串
     * @returnSimpleDateFormat
     */
    public static String string2Timestamp(String str, String pattern) {
    ...
    public static String timestamp2StringLong(Long timestamp) {
     ...
     * 求当天时间与所传参数的差
     **/
    public static Integer timeDifference(String date) {
        DateTimeFormatter pattern = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        TemporalAccessor parse = pattern.parse(date);
        LocalDate last = LocalDate.from(parse);
     ...
     * @return
     */
    public static Integer lastXDate(Integer num) {
        LocalDate now = LocalDate.now();
        LocalDate lastMonth = now.minusDays(num);
        Instant instant = lastMonth.atStartOfDay().atZone(ZoneId.systemDefault()).toInstant();
     ...
     * @return
     */
    public static Integer beginningOfTheDay(String date) {
        LocalDate localDate = LocalDate.parse(date);
        ZonedDateTime zdt = localDate.atStartOfDay(ZoneId.systemDefault());
        return Long.valueOf(Date.from(zdt.toInstant()).getTime()/1000).intValue() ;
    }

    public static Integer endOfTheDay(String date) {

        LocalDate localDate = LocalDate.parse(date);
        localDate = localDate.plus(1, ChronoUnit.DAYS);
        ZonedDateTime zdt = localDate.atStartOfDay(ZoneId.systemDefault());
        return Long.valueOf(Date.from(zdt.toInstant()).getTime()/1000 - 1).intValue() ;
    }
    ...
    public static Date transForDateLong(Long ms){
        if(ms==null){
            ms=0l;
        }
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
