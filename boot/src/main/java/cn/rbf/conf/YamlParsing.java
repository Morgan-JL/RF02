    ...
    if (config.containsKey("server")) {
      ...
      if (serverNode instanceof Map) {
        ...
        if (serverMap.containsKey("port")) {
          server.setPort((Integer) serverMap.get("port"));
        }
        ...
        if(serverMap.containsKey("session-timeout")){
          server.setSessionTimeout((Integer) JavaConversion
              .strToBasic(serverMap.get("session-timeout").toString(),
              int.class,true));
        }
        ...
        if(serverMap.containsKey("close-port")){
          server.setClosePort((Integer) JavaConversion
              .strToBasic(serverMap.get("close-port").toString(),int.class));
        }
        ...
        if(serverMap.containsKey("servlet")){
          ...
          if(obj instanceof Map){
            ...
            for(Map.Entry<String,Map<String,Object>> servletEntry:servletMap.entrySet()){
              ...
              if(servletInfo.containsKey("initializer-params")){
                sm.setInitParams((Map<String,String>)servletInfo.get("initializer-params"));
              }
        ...
        if(serverMap.containsKey("filter")) {
          ...
          if (obj instanceof Map) {
            ...
            for (Map.Entry<String, Map<String, Object>> filterEntry : filterMap.entrySet()) {
              ...
              if (filterInfo.containsKey("initializer-params")) {
                fm.setInitParams((Map<String, String>) filterInfo.get("initializer-params"));
              }
